...
public class CalculoXO {
    int turno;
    int pX;
    int pO;

    public CalculoXO(int turno, int pX, int pO) {
        this.turno = turno;
        this.pX = pX;
        this.pO = pO;
    }
    ...
    public int juego (int matriz [][]){
        // Posibilidades de ganar Horizontal
        ...
        // Posibilidades de ganar Vertical
    ...
    public void rayas (int matriz [][], javax.swing.JPanel p, int n, int i, int j){
        matriz [i][j] = getTurno();
        if (juego (matriz) == n){
            p.setVisible(true);}
    }
    
    public void rayas (int matriz [][], javax.swing.JLabel p, int n, int i, int j){
        matriz [i][j] = getTurno();
        if (juego (matriz) == n){
            p.setVisible(true);}
    }
